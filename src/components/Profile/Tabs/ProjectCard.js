...
class ProjectCard extends React.Component {
  ...
  render() {
    ...
    if (this.state.hovered) {
      titleHeader = <h1 style={{color: color, fontFamily: fontFamily, textAlign: 'center'}}>{ project.title }</h1>;
    } else {
      titleHeader = <h3 style={{color: color, fontFamily: fontFamily, textAlign: 'center'}}>{ project.title }</h3>;
    }
